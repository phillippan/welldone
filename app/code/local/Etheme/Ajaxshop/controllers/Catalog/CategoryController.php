...
class Etheme_Ajaxshop_Catalog_CategoryController extends Mage_Catalog_CategoryController
{
	...
	public function viewAction()
	{
		if($this->getRequest()->isXmlHttpRequest() && (!$this->getRequest()->getParam("fullpageajax") || $this->getRequest()->getParam("ajaxcatalog"))){ //Check if it was an AJAX request
            ...
            /*$toolbar = Mage::app()->getLayout()->getBlock('product_list')->getToolbarBlock();
            $toolbar->setCollection(Mage::app()->getLayout()->getBlock('product_list')->getLoadedProductCollection());
            $toolbar=$toolbar->toHtml();*/
			$response['status'] = 'SUCCESS';
			$response['viewpanel']=$viewpanel;
			$response['productlist'] = $productlist;
            /*$response['toolbar'] = $toolbar;*/
